...
- architecture.md — 17 sleeves/3 families, paper_* tables, key scripts, Alpaca mirror, automation (updated 2026-07-08)
...
- gotchas.md — shadow-file leak, cmd.exe batch traps, yfinance quirks, graphify (updated 2026-07-08)
